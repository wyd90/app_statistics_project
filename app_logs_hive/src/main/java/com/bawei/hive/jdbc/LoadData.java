...
public class LoadData {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        stat.execute("create temporary function jsontomap as 'com.bawei.hive.udf.JsonToMap'");
        ...
        stat.execute("insert into error_logs partition(ym='"+year+month+"',day='"+day+"',hm='"+hour+minute+"') select jsontostr(json,'createdAtMs'),jsontostr(json,'appId'),jsontostr(json,'tenantId'),jsontostr(json,'deviceId'),jsontostr(json,'appVersion'),jsontostr(json,'appChannel'),jsontostr(json,'appPlatform'),jsontostr(json,'osType'),jsontostr(json,'deviceStyle'),jsontostr(json,'errorBrief'),jsontostr(json,'errorDetail')  from error_logs_json where ym='"+year+month+"' and day='"+day+"' and hm='"+hour+minute+"'");
        stat.execute("insert into usage_logs partition(ym='"+year+month+"',day='"+day+"',hm='"+hour+minute+"') select jsontostr(json,'createdAtMs'),jsontostr(json,'appId'),jsontostr(json,'tenantId'),jsontostr(json,'deviceId'),jsontostr(json,'appVersion'),jsontostr(json,'appChannel'),jsontostr(json,'appPlatform'),jsontostr(json,'osType'),jsontostr(json,'deviceStyle'),jsontolong(json,'singleUseDurationSecs'),jsontolong(json,'singleUploadTraffic'),jsontolong(json,'singleDownloadTraffic') from usage_logs_json where ym='"+year+month+"' and day='"+day+"' and hm='"+hour+minute+"'");
        stat.execute("insert into event_logs partition(ym='"+year+month+"',day='"+day+"',hm='"+hour+minute+"') select jsontostr(json,'createdAtMs'),jsontostr(json,'appId'),jsontostr(json,'tenantId'),jsontostr(json,'deviceId'),jsontostr(json,'appVersion'),jsontostr(json,'appChannel'),jsontostr(json,'appPlatform'),jsontostr(json,'osType'),jsontostr(json,'deviceStyle'),jsontostr(json,'eventId'),jsontolong(json,'eventDurationSecs'),jsontomap(json,'paramKeyValueMap') from event_logs_json where ym='"+year+month+"' and day='"+day+"' and hm='"+hour+minute+"'");
        stat.execute("insert into page_logs partition(ym='"+year+month+"',day='"+day+"',hm='"+hour+minute+"') select jsontostr(json,'createdAtMs'),jsontostr(json,'appId'),jsontostr(json,'tenantId'),jsontostr(json,'deviceId'),jsontostr(json,'appVersion'),jsontostr(json,'appChannel'),jsontostr(json,'appPlatform'),jsontostr(json,'osType'),jsontostr(json,'deviceStyle'),jsontoint(json,'pageViewCntInSession'),jsontostr(json,'pageId'),jsontoint(json,'visitIndex'),jsontostr(json,'nextPage'),jsontolong(json,'stayDurationSecs') from page_logs_json where ym='"+year+month+"' and day='"+day+"' and hm='"+hour+minute+"'");
    }
}
